...
import 'package:musica/src/helpers/helpers.dart';
import 'package:musica/src/models/audioplayer.dart';
import 'package:musica/src/widgets/custom_appbar.dart';
...
class _TituloPlayState extends State<TituloPlay>
  ...
  void open() {
    ...
    assetAudioPlayer.open(Audio('assets/Parar-no-Tempo.mp3'));
